...
Type commands and press Enter to execute.
                ...
                <div class="status-bar">
                    Terminal Status: <span id="terminalStatus" class="disconnected">Connecting...</span>
                </div>
                ...
                <script>
                    ...
                    function doResize(event) {
                        ...
                        if (percentage > 25 && percentage < 75) {
                            document.querySelector('.terminal-pane').style.width = percentage + '%';
                            document.querySelector('.browser-pane').style.width = (100 - percentage) + '%';
                        }
                    }
